...
> The functionality of this SDK has been replaced by the **new Asgardeo JavaScript Browser SDK**, which is now part of the official **Asgardeo JavaScript Monorepo**.
>
